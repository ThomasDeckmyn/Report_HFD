...
\section{Circuit Design}
  ...
  \end{eqnarray*}
  Here $\Delta f$ is given by $\frac{BW}{f_0}$. We set the bandwidth to $\SI{50}{\mega\hertz}$ as we found out that in later iterations the bandwidth has the tendency to decrease.

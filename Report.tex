...
\section{Results}
  ...
  It is theoretically possible to measure the 1 dBCP with a NA. This would consist of performing a measurement of $S_21$ for several input powers. If one knows the input power and the gain, the output power is easily calculated. One major drawback of this technique is that a recalibration of the NA is needed for every change of input power. Hence, measuring the 1 dBCP with a NA is theoretically possible, but very impractical. 
  ...
  which is independant of the BW. 
